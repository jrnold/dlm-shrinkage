...
Political processes are rarely constant over time, so there often a need for researchers to estimate time-varying parameters.
...
In addition, for many political processes, the changes are sparse, meaning that for many periods there is little change, and for a few periods there are potentially large changes.
