#' @exportClass McmcdbLocalLevelHp
#' @include sim_ssm-method.R
NULL

setClass("McmcdbLocalLevelHp", contains = "McmcdbWide")

ssm_sim.McmcdbLocalLevelHp <- function(object, data) {
  f <- function(H, Q, ...) {
...
setMethod("ssm_sim", "McmcdbLocalLevelHp", ssm_sim.McmcdbLocalLevelHp)

summary.McmcdbLocalLevelHp <- function(object, data) {
  ret <- list()
...
setMethod("summary", "McmcdbLocalLevelHp", summary.McmcdbLocalLevelHp)
