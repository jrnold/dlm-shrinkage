...
#' @exportClass McmcdbHorseshoe
NULL

setClass("McmcdbHorseshoe", contains = "McmcdbWide")

summary.McmcdbHorseshoe <- function(object, y) {
  ret <- list()
...
setMethod("summary", "McmcdbHorseshoe", summary.McmcdbHorseshoe)
